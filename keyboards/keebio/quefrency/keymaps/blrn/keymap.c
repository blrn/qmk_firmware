...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
        ...
        KC_LCTL, KC_LGUI, KC_LALT, MO(_FN3), KC_SPC, KC_SPC, XXXXXXX, KC_RALT, KC_RCTL, XXXXXXX, KC_APP, KC_RCTL),
    ...
    [_FN3] = LAYOUT(
        KC_GRV, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, _______, KC_DEL,
        HPT_TOG, HPT_FBK, HPT_BUZ, HPT_DWLD, HPT_DWLI, HPT_RST, KC_CALC, _______, KC_HOME, _______, KC_PSCR, _______, _______, _______,
        _______, _______, _______, _______, KC_PGDOWN, _______, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_INSERT, _______, _______,
        _______, _______, _______, _______, _______, KC_PGUP, KC_END, _______, _______, _______, _______, _______, MO(_FN2),
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______),
};
